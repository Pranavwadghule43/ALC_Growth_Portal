...
// Evidence the ALC removed after a reviewer saw it; kept for the review record.
export interface RemovedEvidence extends Evidence { submitted_in: number[]; recorded: boolean }
